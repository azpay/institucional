const en = {
  translation: {
    header: {
      ...
      checkout: "Checkout transparente",
    ...
    produtos: {
      ...
      tabela: {
        ...
        recorrencia: "Recurrence / Subscriptions",
        split: "Payment split",
        gateway: "Payment gateway",
        api: "Payment API",
        checkout: "Transparent checkout",
      ...
      cards: {
        ...
        integracoesText: "Lorem",
        integracoesButton: "Saiba mais",
        bobinas: "Bobinas / Suprimentos",
        bobinasText: "lorem",
        bobinasButton: "Saiba mais",
        sdks: "SDKs iOS / Android",
        sdksText: "lorem",
        sdksButton: "Saiba mais",
        personalizacao: "Personalização / Whitelabel",
        personalizacaoText: "lorem",
        personalizacaoButton: "Saiba mais",
        transferencia: "Transferência entre contas",
        transferenciaText: "lorem",
        transferenciaButton: "Saiba mais",
        disputas: "Disputas e chargebacks",
        disputasText: "lorem",
        disputasButton: "Saiba mais",
        painel: "Painel centralizado",
        painelText: "lorem",
        painelButton: "Saiba mais",
        conciliacao: "Conciliação financeira",
        conciliacaoText: "lorem",
        conciliacaoButton: "Saiba mais",
        cartaopre: "Cartão Pré-Pago",
        cartaopreText: "lorem",
        cartaopreButton: "Saiba mais",
        relatorios: "Relatórios completos",
        relatoriosText: "lorem",
        relatoriosButton: "Saiba mais",
        cobranca: "Cobrança manual",
        cobrancaText: "lorem",
        cobrancaButton: "Saiba mais",
        multi: "Multi-contas",
        multiText: "lorem",
        multiButton: "Saiba mais",
        analise: "Análise de risco e fraude",
        analiseText: "lorem",
        analiseButton: "Saiba mais",
        politicas: "Políticas de recebemento",
        politicasText: "lorem",
        politicasButton: "Saiba mais",
        documentacao: "Documentação técnica",
        documentacaoText: "lorem",
        documentacaoButton: "Saiba mais",
      },
    },
    splitPagamento: {
      title:
    ...
    help: {
      ...
      chat: {
        title: "Chat",
        subtitle: "Talk to us now, we'rehere from 8am to 6pm on weekdays.",
      },
      ticket: {
        title: "Open a ticket",
